...
public class EmailController {
	...
	public String write(@ModelAttribute("emailVO") EmailVO emailVO, Model model) {
		...
		emailVO.setEms_from_email("iakwpi@naver.com");
	...
	public String write(@ModelAttribute("emailVO") EmailVO emailVO,@RequestParam MultipartFile file1, BindingResult result, Model model) {
